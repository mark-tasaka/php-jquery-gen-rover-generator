...
<html>
<head>
<title>Launch Page: MCC Rover Character Generator</title>
...
<body>
	...
	<section>
		...
		<h1><img src="images/title.png" alt="Rover Character Generator" class="image" /></h1>
		...
		<form action="" id ="roverForm2"  target="_blank" method="post">
        ...
        $("#generate_characters2").click(function(){
            ...
            $("#roverForm2").attr('action', "character2/mcc_rover_"+ $("#level").val() + $("#abilityScores").val() +  ".php");
        });
